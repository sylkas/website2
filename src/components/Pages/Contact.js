...
export default withFormik({
    ...
    validationSchema: Yup.object().shape({
        name: Yup.string().min(3, 'Name is too short').required('You must give us your name'),
        email: Yup.string().email('Give valid email').required('Email is required'),
        phone: Yup.string()
            .min(10, '10 digit or more')
            .max(15, 'Too long')
            .required('Give you phone number'),
        message: Yup.string().min(100, 'Give more details').required('Message is required'),            
    }),
